        ...
        <Container>
            ...
            <Grid container justifyContent="center" alignItems="center" rowSpacing={3} mt={1} >
                <Grid item md={12} xs={12}>
                    ...
                    <Typography variant="body1" >Please add the customer information.</Typography>
                </Grid>
                <Grid item md={6} xs={12}>
                    <TextField value={customer.name} name="name" onChange={handleChange} fullWidth label="Full Name" />
                </Grid>
                <Grid item md={6} xs={12}>
                ...
                <Grid item md={6} xs={12}>
                    <TextField value={customer.plz} name="plz" onChange={handleChange} fullWidth label="Postal Code" />
                </Grid>
                <Grid item md={6} xs={12}>
                    <TextField value={customer.city} name="city" onChange={handleChange} fullWidth label="City" />
                </Grid>

                <Grid item md={6} xs={12}>
                    <TextField value={customer.telefon} name="telefon" onChange={handleChange} fullWidth label="Phone" />
                </Grid>
